...
- **Workflow Nodes (`src/nodes.py`):** GPT-4o-mini-powered analysis, question generation, and routing
...
├── config/
│   └── prompts.py          # GPT-4o-mini prompt templates
├── output/                 # Generated markdown files
├── sessions/               # Session persistence storage
...
✅ **Multi-step reasoning** - GPT-4o-mini analyzes needs, asks follow-ups, makes decisions
